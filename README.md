...
本项目本体采用 **[Mozilla Public License Version 2.0 (MPL-2.0)](https://www.mozilla.org/en-US/MPL/2.0/)** 许可证开源。

> [!NOTE]
> **许可证说明**：
> 本项目中引用的部分代码基于 **MIT 许可证** 开源。在遵守 MPL-2.0 的同时，请同样尊重原作者的 MIT 协议要求。
> 详情请参阅原项目协议：
